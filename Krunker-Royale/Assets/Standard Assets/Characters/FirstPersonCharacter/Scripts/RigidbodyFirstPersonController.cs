...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : NetworkBehaviour
    {
        ...
        private void Update()
        {
            ...
            //Renderer soldierRenderer = selectedObject.transform.FindChild("nameOfChildObject").GetComponent<MeshRenderer>();
            
            // Do something with the renderer here...
            //soldierRenderer.enabled = false; // like disable it for example. 
            //gameObject.transform.Find("Soldier_demo").GetComponent<MeshRenderer>().enabled = false;
