...
public class BRS_ChangeCircle : NetworkBehaviour
{
	[Range(0, 360)]
	[SyncVar]public int Segments;
	[Range(0,5000)]
	[SyncVar] public float XRadius;
	[Range(0,5000)]
	[SyncVar] public float YRadius;  //THIS IS NOT USED - SHOULD BE ELIMINATED
  ...
  public List<int> ZoneTimes;
	...
	void Update ()
	{
        ...
        playerRadius = (float)System.Math.Pow(player.transform.position.x - centerPoint.x, 2) + (float)System.Math.Pow(player.transform.position.z - centerPoint.z, 2);
